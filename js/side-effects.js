...
(function (d3,queue) {
    ...
    var backgroundLayerSE = svg.append("svg");
    backgroundLayerSE
        .attr("class", "background-layer")
        .attr("width", width)
        .attr("height", height);

    var textLayerSE = svg.append("svg");
    textLayerSE
    ...
    d3.json("data/druginfo.json", function (error, druginfo) {
        ...
        function update() {
            d3.json("data/ram/locations.json?nocache=" + (new Date()).getTime(), function (error, locations) {
                ...
                var rowTitles = textLayerSE.selectAll("text.row-title").data(sideEffects);
                ...
                var backgroundBanners = backgroundLayerSE.selectAll("rect.background-banner").data(leftToRightLocations, l => l.id);
                ...
                var auxLines = backgroundLayerSE.selectAll("line.aux-line").data(sideEffects, function (d) {
                    return d;
                });
                ...
                /////////////////////////////////////////
                var medBoxes = backgroundLayerSE.selectAll("rect.med-box").data(leftToRightLocations, l => l.id);
